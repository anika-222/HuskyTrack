#!/usr/bin/env python3
"""
UW CSE Course Scraper - Final Clean Version
Handles simultaneous prerequisites and cleans descriptions
"""
...
class UWCourseScraper:
    ...
    def extract_prerequisites_and_exclusions(self, description_text: str) -> tuple:
        """Extract prerequisites, simultaneous prerequisites, and exclusions from the full description text"""
        prerequisites = ""
        ...
        # Clean description - remove prerequisite/exclusion text
        ...
        return clean_description, prerequisites, simultaneous_prereqs, exclusions
    ...
    def parse_course_from_text(self, course_line: str, description_line: str) -> Optional[Dict]:
        ...
        # Extract description, prerequisites, simultaneous prereqs, and exclusions
        description, prerequisites, simultaneous_prereqs, exclusions = self.extract_prerequisites_and_exclusions(description_line)
    ...
    def save_to_csv(self, filename: str = "course_information_final.csv"):
        """Save CSE courses to CSV file with clean descriptions"""
        if not self.courses:
        ...
        # Reorder columns
        column_order = ['course_number', 'course_title', 'description', 'prerequisites', 'simultaneous_prerequisites', 'exclusions', 'category']
        df = df[column_order]
